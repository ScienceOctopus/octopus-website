...
banner: "img/blog-images/header-images/2018-02-XX_reproducible-blogposts.png"
---
...
- [R Questions on StackOverflow](https://www.kaggle.com/stackoverflow/rquestions): Full text of all StackOverflow Q&As in the R tag up to September 2017
...
The top and bottom of all my blogposts shows a rating for the reproducibility of the content with the following considerations:

- Is the author citable?
- Is the data citable?
- Is the code citable (and replicable)?

For the ratings I'll use the following Font Awesome icons:
...
As of the first implementation of these ratings (early February 2018), I simply include raw HTML into the blogpost. As `blogdown` Hugo templates automatically create summaries from the first X characters of the post, this messed up my blog summaries a lot. Thankfully, Yihui has a blogpost on [modifying hugo post summaries](https://yihui.name/en/2017/08/hugo-post-summary/) that was fairly easy to implement. To be explicit, I introduced the following code:
...
Please note that these instructions are only valid for the [devcows/hugo-universal-theme](https://github.com/devcows/hugo-universal-theme) that my blog was using at the time of writing in February 2018. However, it's a massive improvement over the default theme as now I can write completely custom click-bait summaries for my blogs, and include emojis `r emo::ji("rabbit")`, by adding this to the YAML of a post :
...
At the moment it's likely only going to be myself writing posts for this blog, and I might not look at many datasets at once, but this template is extensible enough it can support multiple authors:
...
<div class="row">
    <div class="col-sm-4">
        <center> <span class="fa fa-star fa-2x text-center" style="color:Tomato"></span>
            <p><a href='/blog/2018/02/07/2018-xx-xx_reproducible-blogposts/#reproducability-ratings' data-toggle="tooltip" data-placement="right" title="" data-original-title="Click for info" style='font-weight:bold;color:black;text-decoration:underline;'>Citable Author<i class="fa fa-question-circle "></i></a>
                <br>
                Martin John Hadley
                <br>
                ...
                Philippa Matthews
                <br>
                (<a href="https://orcid.org/0000-0002-4036-4269" target="orcid.widget" rel="noopener noreferrer" style="vertical-align:top;"><img src="/img/orcid_16x16.png" style="width:1em;margin-right:.2em;" alt="ORCID iD icon">orcid.org/0000-0002-4036-4269</a>)
        </center>
    </div>
    <div class="col-sm-4">
        <center> <span class="fa fa-star fa-2x text-center" style="color:Tomato"></span>
            <p><a href='/blog/2018/02/07/2018-xx-xx_reproducible-blogposts/#reproducability-ratings' data-toggle="tooltip" data-placement="right" title="" data-original-title="Click for info" style='font-weight:bold;color:black;text-decoration:underline;'>Citable Data<i class="fa fa-question-circle "></i></a>
                <br>
                <a href="http://doi.org/10.1038/srep00196" target="orcid.widget" rel="noopener noreferrer" style="vertical-align:top;"><img src="/img/doi_16x16.png" style="width:1em;margin-right:.2em;" alt="ORCID iD icon">doi:10.1038/srep00196</a>
        </center>
    </div>
    <div class="col-sm-4">
        <center> <span class="fa fa-star-half-o fa-2x text-center" style="color:Tomato"></span>
            <p><a href='/blog/2018/02/07/2018-xx-xx_reproducible-blogposts/#reproducability-ratings' data-toggle="tooltip" data-placement="right" title="" data-original-title="Click for info" style='font-weight:bold;color:black;text-decoration:underline;'>Citable Code<i class="fa fa-question-circle "></i></a>
                <br>
...
For the time being I'm going to be manually adding these components to my posts, but I have a [placeholder repository](https://github.com/visibledata/blogrducible) where I'll package together tools I regularly use the blog into. Note the use of the the following feature of RMarkdown V2 that's used to allow for neatly indented HTML to remain unprocessed in the .Rmd file:
